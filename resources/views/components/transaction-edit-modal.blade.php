        ...
        <div class="bg-white rounded-lg shadow-2xl border border-blue-100">
            ...
            <div class="px-6 py-4">
                <form id="editTransactionForm" method="POST">
                    ...
                    <input type="hidden" name="payment_type" value="select">
                    <input type="hidden" name="payment_term_id" id="edit-payment-term-id">
...
<script>
    ...
    window.editTransaction = function (id, description, paymentTermName, paymentTermId) {
        ...
        const paymentTermIdInput = document.getElementById('edit-payment-term-id');
        ...
        if(paymentTermIdInput){
            paymentTermIdInput.value = paymentTermId || '';
        }
